...
\usepackage{graphicx}   %使用宏包，用于加载图片
\usepackage{textcomp,booktabs}
\usepackage[usenames,dvipsnames]{color}
\usepackage{colortbl}
\usepackage[75437]{MCMthesis}\problem{C}    %填写控制号、题号，年份不需要填（自动以当前电脑时间年份为准）
...
\def\abstractname{}  %摘要标题
\title{Effects of Sleep on Human Body}  %标题
...
\maketitle  %生成sheet页
\thispagestyle{empty}   %去摘要页页脚
\pagestyle{empty}       %去目录页页眉
